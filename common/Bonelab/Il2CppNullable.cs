// https://github.com/yowchap/BoneLib/blob/main/BoneLib/BoneLib/Nullables/BoxedNullable.cs
using HarmonyLib;
using System;
...
public class Il2CppNullable<T> : Il2CppSystem.ValueType
    where T : unmanaged {
  ...
  public unsafe Il2CppNullable(T? nullable) {
...
/// <summary>
/// Allows <see cref="BoneLib.Nullables.Il2CppNullable{T}"/> to compile, with
/// its <c>where T : unmanaged</c> type stipulation.
/// </summary>
