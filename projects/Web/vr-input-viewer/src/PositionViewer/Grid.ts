  ...
  constructor(
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          float lines = line(lineThickness, fract(vUv.x * lineSpacing), lineThickness, lineThickness/2.0);
          lines += line(lineThickness, fract(vUv.y * lineSpacing), lineThickness, lineThickness/2.0);
