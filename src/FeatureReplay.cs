...
class FeatureReplay : Feature {
    ...
    Handler =
        () => {
          if (s_hotkey_replay == null) {
            ...
            s_hotkey_replay = new Replay.Replay(
  ...
  public override void OnSceneWasInitialized(int buildIndex, string sceneName) {
    ...
    if (s_hotkey_recorder != null)
      s_hotkey_recorder.OnSceneChange();
  }

  public override void OnUpdate() {
    if (s_hotkey_recorder != null)
      s_hotkey_recorder.OnUpdate(s_currentSceneIdx);
    if (s_hotkey_ghost != null)
      s_hotkey_ghost.OnUpdate(s_currentSceneIdx);
  }
}
}
