...
public struct Controller : IFlatbufferObject
{
  ...
  public static void StartController(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<Bwr.Controller> EndController(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // position
    builder.Required(o, 6);  // rotation_euler
    return new Offset<Bwr.Controller>(o);
  }
}
