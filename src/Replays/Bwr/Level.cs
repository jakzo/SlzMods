...
public struct Level : IFlatbufferObject
{
  ...
  public bool Completed { get { int o = __p.__offset(10); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  /// Level number
  public int SceneIndex { get { int o = __p.__offset(12); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Byte offset of first frame of level within the file
  public int FrameOffset { get { int o = __p.__offset(14); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<Bwr.Level> CreateLevel(FlatBufferBuilder builder,
    ...
    Level.AddCompleted(builder, completed);
    return Level.EndLevel(builder);
  }

  public static void StartLevel(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static void AddCompleted(FlatBufferBuilder builder, bool completed) { builder.AddBool(3, completed, false); }
  public static void AddSceneIndex(FlatBufferBuilder builder, int sceneIndex) { builder.AddInt(4, sceneIndex, 0); }
  public static void AddFrameOffset(FlatBufferBuilder builder, int frameOffset) { builder.AddInt(5, frameOffset, 0); }
